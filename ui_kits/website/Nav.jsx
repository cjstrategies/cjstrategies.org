    ...
    >
      ...
      >
        ...
        <div className="cjs-nav-cta" style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <Button href="#donate" variant="primary" size="md">Donate</Button>
        </div>
        ...
        >
          <nav style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <div style={{ marginTop: 16 }}>
              <Button href="#donate" variant="primary" size="lg" style={{ width: "100%", justifyContent: "center" }}>Donate</Button>
            </div>
          </nav>
        </div>
      )}
